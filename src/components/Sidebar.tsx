              ...
              return (
                <li key={item.id}>
                  <button
                    ...
                    onMouseEnter={(e) => {
                      if (!isActive) e.currentTarget.style.backgroundColor = isDark ? '#18181b' : 'rgba(0,0,0,0.02)';
                    }}
                    onMouseLeave={(e) => {
        ...
        {userIsAdmin && (
          <div className="px-2 pb-2">
            <a href="/admin"
              ...
              onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = isDark ? '#18181b' : 'rgba(0,0,0,0.02)'; }}
